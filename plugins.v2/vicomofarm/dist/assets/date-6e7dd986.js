...
function createLayout(props) {
  ...
  const layoutClasses = toRef$4(() => ['v-layout', {
    'v-layout--full-height': props.fullHeight
  }]);
  const layoutStyles = toRef$4(() => ({
...
const {ref: ref$2,shallowRef: shallowRef$2,watch: watch$2} = await importShared('vue');
...
function createTheme(options) {
  ...
  const themeClasses = toRef$2(() => parsedOptions.isDisabled ? undefined : `v-theme--${name.value}`);
  return {
    install,
...
function provideTheme(props) {
  ...
  const themeClasses = toRef$2(() => theme.isDisabled ? undefined : `v-theme--${name.value}`);
  const newTheme = {
    ...theme,
    name,
    current,
...
export { isPrimitive as $, deepEqual as A, wrapInArray as B, findChildrenWithProvide as C, useTheme as D, useIcon as E, flattenFragments as F, useResizeObserver as G, IN_BROWSER as H, IconValue as I, hasEvent as J, keyCodes as K, useLocale as L, EventProp as M, filterInputAttrs as N, matchesSelector as O, omit as P, callEvent as Q, pick as R, SUPPORTS_INTERSECTION as S, makeDisplayProps as T, useDisplay as U, useGoTo as V, focusableChildren as W, consoleError as X, defineComponent as Y, deprecate as Z, getPropertyFromItem as _, isOn as a, focusChild as a0, CircularBuffer as a1, defer as a2, templateRef as a3, isClickInsideElement as a4, getNextElement as a5, debounce as a6, ensureValidVNode as a7, checkPrintable as a8, noop as a9, VuetifyLayoutKey as aA, refElement as aB, VClassIcon as aC, VComponentIcon as aD, VLigatureIcon as aE, VSvgIcon as aF, mergeDeep as aG, createDefaults as aH, createDisplay as aI, createTheme as aJ, createIcons as aK, createLocale as aL, createDate as aM, createGoTo as aN, DefaultsSymbol as aO, DisplaySymbol as aP, ThemeSymbol as aQ, IconSymbol as aR, LocaleSymbol as aS, DateOptionsSymbol as aT, DateAdapterSymbol as aU, GoToSymbol as aV, useDefaults as aW, pickWithRest as aa, keys as ab, getEventCoordinates as ac, HSVtoRGB as ad, RGBtoHSV as ae, HSVtoHSL as af, HSLtoHSV as ag, HSVtoHex as ah, HexToHSV as ai, has as aj, getDecimals as ak, createRange as al, keyValues as am, SUPPORTS_EYE_DROPPER as an, HSVtoCSS as ao, RGBtoCSS as ap, getContrast as aq, isComposingIgnoreKey as ar, getObjectValueByPath as as, isEmpty as at, defineFunctionalComponent as au, breakpoints as av, useDate as aw, humanReadableFileSize as ax, provideLocale as ay, useLayout as az, getCurrentInstance as b, makeThemeProps as c, provideTheme as d, eventName as e, createLayout as f, genericComponent as g, provideDefaults as h, includes as i, convertToUnit as j, destructComputed as k, isCssColor as l, makeLayoutProps as m, isParsableColor as n, parseColor as o, propsFactory as p, getForeground as q, getCurrentInstanceName as r, isObject as s, clamp as t, useRtl as u, consoleWarn as v, makeLayoutItemProps as w, useProxiedModel as x, useToggleScope as y, useLayoutItem as z };
