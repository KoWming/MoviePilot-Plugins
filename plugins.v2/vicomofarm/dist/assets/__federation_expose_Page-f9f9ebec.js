...
const Page_vue_vue_type_style_index_0_scoped_62356147_lang = '';
...
const _hoisted_9 = { class: "timeline-date" };
...
const _hoisted_22 = { style: {"margin-bottom":"12px"} };
...
async function handlePurchase() {
  ...
  try {
    ...
    console.log('[VicomoFarm] handlePurchase: 购买数量', num);
    if (!num || num <= 0 || !Number.isInteger(num)) {
      purchaseError.value = '请输入有效的购买数量';
      purchaseLoading.value = false;
      console.warn('[VicomoFarm] handlePurchase: 非法购买数量', purchaseAmount.value);
      return;
    }
    const url = `plugin/${pluginId}/purchase?buy_num=${num}`;
    console.log('[VicomoFarm] handlePurchase: 请求URL', url);
    // 后端GET接口 /plugin/VicomoFarm/purchase?buy_num=xxx
    const res = await props.api.post(url);
    console.log('[VicomoFarm] handlePurchase: 返回结果', res);
    if (res && res.success) {
      ...
      console.error('[VicomoFarm] handlePurchase: 购买失败', res);
    }
  } catch (e) {
    purchaseError.value = e.message || '购买失败';
    console.error('[VicomoFarm] handlePurchase: 异常', e);
  } finally {
    purchaseLoading.value = false;
    setTimeout(() => { purchaseError.value = ''; purchaseSuccess.value = ''; }, 3000);
  }
}
...
async function handleSale() {
  ...
  try {
    ...
    // 后端POST接口 /plugin/VicomoFarm/sale?sale_num=xxx
    const res = await props.api.post(url);
    if (res && res.success) {
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_card_title, { class: "text-caption px-3 py-2 bg-primary-lighten-5 d-flex align-center" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[19] || (_cache[19] = _createElementVNode("span", null, "农场信息", -1)),
                            _createVNode(_component_v_spacer),
                            _createVNode(_component_v_btn, {
                              color: "primary",
                              variant: "text",
                                ...
                                (latestFarmInfo.value && latestFarmInfo.value.farm)
                                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[20] || (_cache[20] = _createElementVNode("span", null, "名称：", -1)),
                                      ...
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[21] || (_cache[21] = _createElementVNode("span", null, "类型：", -1)),
                                      ...
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[22] || (_cache[22] = _createElementVNode("span", null, "状态：", -1)),
                                      ...
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[24] || (_cache[24] = _createElementVNode("span", null, "剩余配货量：", -1)),
                                          _createElementVNode("span", _hoisted_5, _toDisplayString(latestFarmInfo.value.farm.剩余配货量 || '未知') + "kg", 1),
                                      ...
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[25] || (_cache[25] = _createElementVNode("span", null, "说明：", -1)),
                                          _createElementVNode("span", _hoisted_6, _toDisplayString(latestFarmInfo.value.farm.说明 || '无'), 1)
                                        ]),
                                        _: 1
                                      })
                                    ], 64))
                                  : (_openBlock(), _createBlock(_component_v_list_item, { key: 1 }, {
                                      default: _withCtx(() => [
                                        _cache[27] || (_cache[27] = _createElementVNode("span", { class: "text-subtitle-2" }, "暂无数据", -1)),
                                        _createVNode(_component_v_tooltip, { location: "top" }, {
                                          ...
                                          default: _withCtx(() => [
                                            _cache[26] || (_cache[26] = _createElementVNode("span", null, "数据加载中或暂无数据", -1))
                                          ]),
                                          _: 1
                                        })
                                      ]),
              ...
              default: _withCtx(() => [
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_v_card_title, { class: "text-caption d-flex align-center px-3 py-2 bg-primary-lighten-5" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[28] || (_cache[28] = _createElementVNode("span", null, "历史记录", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_v_card_text, { class: "px-3 py-2" }, {
                                      ...
                                      return (_openBlock(), _createBlock(_component_v_timeline_item, {
                                        ...
                                        default: _withCtx(() => [
                                          ...
                                          _createElementVNode("div", _hoisted_10, [
                                            _cache[29] || (_cache[29] = _createElementVNode("div", { class: "text-subtitle-2 mb-1" }, "象草余额", -1)),
                                            _createElementVNode("div", _hoisted_11, _toDisplayString(item.farm_info.bonus || '未知'), 1),
                                            _cache[30] || (_cache[30] = _createElementVNode("div", { class: "text-subtitle-2 mt-2 mb-1" }, "农场信息", -1)),
                                            ...
                                            _cache[31] || (_cache[31] = _createElementVNode("div", { class: "text-subtitle-2 mt-2 mb-1" }, "蔬菜店信息", -1)),
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_card, {
                      flat: "",
                      class: "border rounded info-card"
                    }, {
                      default: _withCtx(() => [
                        _createVNode(_component_v_card_title, { class: "text-caption px-3 py-2 bg-primary-lighten-5 d-flex align-center" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[32] || (_cache[32] = _createElementVNode("span", null, "蔬菜店信息", -1))
                          ]),
                          _: 1
                        }),
                        _createVNode(_component_v_card_text, { class: "px-3 py-2" }, {
                          default: _withCtx(() => [
                                ...
                                (latestFarmInfo.value && latestFarmInfo.value.vegetable_shop)
                                  ? (_openBlock(), _createElementBlock(_Fragment, { key: 0 }, [
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[33] || (_cache[33] = _createElementVNode("span", null, "名称：", -1)),
                                          _createElementVNode("span", _hoisted_14, _toDisplayString(latestFarmInfo.value.vegetable_shop.名称 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[34] || (_cache[34] = _createElementVNode("span", null, "市场单价：", -1)),
                                          _createElementVNode("span", _hoisted_15, _toDisplayString(latestFarmInfo.value.vegetable_shop.市场单价 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[35] || (_cache[35] = _createElementVNode("span", null, "库存：", -1)),
                                          _createElementVNode("span", _hoisted_16, _toDisplayString(latestFarmInfo.value.vegetable_shop.库存 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[36] || (_cache[36] = _createElementVNode("span", null, "成本：", -1)),
                                          _createElementVNode("span", _hoisted_17, _toDisplayString(latestFarmInfo.value.vegetable_shop.成本 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[37] || (_cache[37] = _createElementVNode("span", null, "开店累计盈利：", -1)),
                                          _createElementVNode("span", _hoisted_18, _toDisplayString(latestFarmInfo.value.vegetable_shop.开店累计盈利 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[38] || (_cache[38] = _createElementVNode("span", null, "盈利目标：", -1)),
                                          _createElementVNode("span", _hoisted_19, _toDisplayString(latestFarmInfo.value.vegetable_shop.盈利目标 || '未知'), 1)
                                        ]),
                                        _: 1
                                      }),
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          _cache[40] || (_cache[40] = _createElementVNode("span", null, "可卖数量：", -1)),
                                          _createElementVNode("span", _hoisted_20, _toDisplayString(latestFarmInfo.value.vegetable_shop.可卖数量 || '未知'), 1),
                                      ...
                                      _createVNode(_component_v_list_item, { class: "d-flex align-center" }, {
                                        ...
                                        default: _withCtx(() => [
                                          ...
                                          _createElementVNode("span", _hoisted_21, _toDisplayString(latestFarmInfo.value.vegetable_shop.说明 || '无'), 1)
                                        ]),
                                        _: 1
                                      })
                                    ], 64))
                            ...
                            _createVNode(_component_v_dialog, {
                              ...
                              "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((saleDialog).value = $event)),
                              "max-width": "340"
                            }, {
                              default: _withCtx(() => [
                                    ...
                                    _createVNode(_component_v_card_text, null, {
                                      default: _withCtx(() => [
                                        _createElementVNode("div", _hoisted_22, [
                                          _cache[45] || (_cache[45] = _createTextVNode(" 当前可卖出数量：")),
                                          _createElementVNode("b", null, _toDisplayString(latestFarmInfo.value.vegetable_shop.可卖数量 || '未知'), 1)
                                        ]),
                                        _createVNode(_component_v_text_field, {
                                          modelValue: saleAmount.value,
                                          "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => ((saleAmount).value = $event)),
                                          label: "出售数量（kg）",
                                          placeholder: "请输入出售数量",
                                          type: "number",
                                          min: "1",
                                          max: latestFarmInfo.value.vegetable_shop.可卖数量,
                                          step: "1",
                                          rules: [
                          v => !!v || '请输入出售数量',
                          v => Number(v) > 0 || '数量需大于0',
                                    ...
                                    _createVNode(_component_v_card_actions, { class: "justify-end" }, {
                                      default: _withCtx(() => [
                                        ...
                                        _createVNode(_component_v_btn, {
                                          color: "grey",
                                          text: "",
                                          onClick: _cache[3] || (_cache[3] = $event => (saleDialog.value = false))
                                        }, {
    ...
    _createVNode(_component_v_dialog, {
      ...
      "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((purchaseDialog).value = $event)),
      "max-width": "340"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_v_card, null, {
            ...
            _createVNode(_component_v_card_text, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_23, [
                  _cache[51] || (_cache[51] = _createTextVNode(" 当前剩余配货量： ")),
                  _createElementVNode("b", null, _toDisplayString(latestFarmInfo.value.farm.剩余配货量 || '未知'), 1),
                  _cache[52] || (_cache[52] = _createTextVNode(" kg "))
                ]),
                _createVNode(_component_v_text_field, {
                  modelValue: purchaseAmount.value,
                  "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((purchaseAmount).value = $event)),
                  label: "进货数量（kg）",
                  placeholder: "请输入进货数量",
                  type: "number",
                  rules: [
              ...
              v => Number(v) <= Number(latestFarmInfo.value.farm.剩余配货量) || '不能超过剩余配货量'
                  ...
                  min: "1",
                  max: latestFarmInfo.value.farm.剩余配货量,
                  required: "",
                  "hide-details": "auto",
                  style: {"margin-bottom":"0"}
            ...
            _createVNode(_component_v_card_actions, { class: "justify-end" }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_v_btn, {
                  color: "grey",
                  text: "",
                  onClick: _cache[8] || (_cache[8] = $event => (purchaseDialog.value = false))
                }, {
...
const PageComponent = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-62356147"]]);
