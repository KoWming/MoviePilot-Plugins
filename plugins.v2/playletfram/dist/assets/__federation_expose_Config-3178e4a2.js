...
const Config_vue_vue_type_style_index_0_scoped_fb57a5ce_lang = '';
      ...
      default: _withCtx(() => [
        _createVNode(_component_v_card_title, { class: "text-subtitle-1 d-flex align-center px-3 py-2 bg-gradient-primary" }, {
          default: _withCtx(() => [
            ...
            _cache[17] || (_cache[17] = _createElementVNode("span", { class: "text-white" }, "开心农场配置", -1)),
                                  ...
                                  _createElementVNode("div", _hoisted_4, [
                                    _createElementVNode("div", _hoisted_5, [
                                      _cache[21] || (_cache[21] = _createElementVNode("div", { class: "setting-text" }, [
                                        ...
                                        _createElementVNode("div", { class: "text-caption text-grey" }, "是否启用开心农场插件")
                                      ], -1)),
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_card_title, { class: "text-subtitle-2 px-3 py-2 bg-blue-lighten-5 d-flex align-center" }, {
                      default: _withCtx(() => [
                        ...
                        _cache[41] || (_cache[41] = _createTextVNode(" 玩法说明 ", -1))
                      ]),
                      _: 1
                    }),
                    _createVNode(_component_v_card_text, { class: "px-3 py-2 text-caption" }, {
                      default: _withCtx(() => [
                        _cache[43] || (_cache[43] = _createElementVNode("div", { class: "mb-2" }, [
                          _createElementVNode("strong", null, "🎯 核心目标："),
                          _createTextVNode("通过种植农作物、养殖动物收获物品，在菜市场出售获取魔力值，积累资源解锁更高价值的动植物，成为农场大亨～")
                        ], -1)),
                        _createVNode(_component_v_divider, { class: "my-2" }),
                        _cache[44] || (_cache[44] = _createElementVNode("div", { class: "mb-1" }, [
                          _createElementVNode("strong", null, "📚 基础概念：")
                        ], -1)),
                        _cache[45] || (_cache[45] = _createElementVNode("ul", { class: "pl-4 mb-2" }, [
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "💎 魔力值："),
                            _createTextVNode("游戏核心货币，用于种植/养殖，出售物品可获得，页面顶部实时显示")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "⏳ 成长时间："),
                            _createTextVNode("作物/动物从种植/养殖到可收获的时间（单位：小时）")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "📅 有效期："),
                            _createTextVNode("收获后物品存入仓库，超过有效期自动失效（作物2天，动物5天）")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "📈 市场价格："),
                            _createTextVNode("出售物品的单价，每24小时随机波动±20%，菜市场可查看实时价格")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "🏠 仓库："),
                            _createTextVNode("存放收获的物品，最多存储10种不同物品，需及时出售避免过期")
                          ])
                        ], -1)),
                        _createVNode(_component_v_divider, { class: "my-2" }),
                        _cache[46] || (_cache[46] = _createElementVNode("div", { class: "mb-1" }, [
                          _createElementVNode("strong", null, "👣 操作步骤：")
                        ], -1)),
                        _cache[47] || (_cache[47] = _createElementVNode("ol", { class: "pl-4 mb-2" }, [
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "🌱 种植/养殖："),
                            _createTextVNode("在「农作物种植区」或「动物养殖区」，选择物品点击「种植」/「养殖」（需消耗对应魔力值，且未处于该物品的种植/养殖中）")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "🌾 收获物品："),
                            _createTextVNode("物品成熟后（剩余时间为0），点击「收获」或顶部「一键收获」，物品自动存入仓库")
                          ]),
                          _createElementVNode("li", null, [
                            _createElementVNode("strong", null, "💰 出售赚钱："),
                            _createTextVNode("在「仓库」选择未过期物品点击「出售」，按菜市场实时价格获得魔力值（建议价格上涨时出售，赚更多哦）")
                          ])
                        ], -1)),
                        _createVNode(_component_v_alert, {
                          ...
                          default: _withCtx(() => [...(_cache[42] || (_cache[42] = [
                            _createElementVNode("strong", null, "💡 温馨提示：", -1),
                            _createElementVNode("br", null, null, -1),
                            _createTextVNode(" 1. 魔力值不足时，可先出售仓库物品获取资源", -1),
                            _createElementVNode("br", null, null, -1),
                            _createTextVNode(" 2. 同一物品同一时间只能种植/养殖一次，需收获后才能再次操作", -1),
                            _createElementVNode("br", null, null, -1),
                            _createTextVNode(" 3. 定期查看仓库物品有效期，避免过期损失", -1),
                            _createElementVNode("br", null, null, -1),
                            _createTextVNode(" 4. 市场价格每天更新一次，可关注高价时段集中出售 ", -1)
                          ]))]),
                          _: 1
                        })
                      ]),
...
const ConfigComponent = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-fb57a5ce"]]);
